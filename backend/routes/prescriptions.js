...
// ============================================
// GET Prescriptions d'un médecin
// ============================================
...
router.post('/', async (req, res) => {
    const { id_beneficiaire, id_medecin, medicaments, posologie, duree, instructions } = req.body;

    if (!id_beneficiaire || !id_medecin) {
        return res.status(400).json({ error: "Patient et médecin requis" });
    }
...
router.put('/:id', async (req, res) => {
    ...
    const { medicaments, posologie, duree, instructions } = req.body;
